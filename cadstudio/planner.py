...
parts.features contains planar face sketches for add/cut. Do not invent new face indices: only modify existing validated features from the current design. Preserve their support_face_count and normal. For a new arbitrary outline use extrusion.
